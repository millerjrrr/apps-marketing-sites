...
const Contact = () => {
  return (
    <div className="flex w-full flex-1 items-center justify-center p-5 py-20">
      <div className="inner-container flex-col items-center rounded-[30px] bg-SECONDARY shadow-[0_0_10px_0_rgba(255,255,255,0.9)]">
        ...
        <div className="flex flex-col items-center pb-10 lg:flex-row">
          ...
          />
          <div className="mt-5 flex flex-col rounded-[30px] border-[3px] border-CONTRAST p-5 pl-5 lg:ml-5">
          ...
          <div className="flex flex-col p-5">
            <div className="personal-detail">
              <MdEmail className="mr-2 text-lg text-WHITE" />
              <p>jacob@griddier.com</p>
            </div>
            <div className="personal-detail">
              <FaLinkedin className="mr-2 text-lg text-WHITE" />
              <a
